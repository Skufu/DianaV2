...
func TestValidationService_ValidateBiomarkerRanges(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			values:    map[string]any{"fbs": 90.0, "hba1c": 5.4, "bmi": 22.0},
			wantValid: true,
			wantWarn:  0,
		},
		{
			name:      "FBS too low",
			values:    map[string]any{"fbs": 30.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "FBS too high",
			values:    map[string]any{"fbs": 700.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "HbA1c too low",
			values:    map[string]any{"hba1c": 3.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "HbA1c too high",
			values:    map[string]any{"hba1c": 16.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
		...
		},
		{
			...
			values:    map[string]any{"systolic": 65.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "systolic too high",
			values:    map[string]any{"systolic": 260.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "diastolic too low",
			values:    map[string]any{"diastolic": 35.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "diastolic too high",
			values:    map[string]any{"diastolic": 160.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "cholesterol too low",
			values:    map[string]any{"cholesterol": 95.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "cholesterol too high",
			values:    map[string]any{"cholesterol": 420.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "LDL too low",
			values:    map[string]any{"ldl": 25.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "LDL too high",
			values:    map[string]any{"ldl": 320.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "HDL too low",
			values:    map[string]any{"hdl": 12.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "HDL too high",
			values:    map[string]any{"hdl": 130.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "triglycerides too low",
			values:    map[string]any{"triglycerides": 15.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
			name:      "triglycerides too high",
			values:    map[string]any{"triglycerides": 1100.0},
			wantValid: false,
			wantWarn:  1,
		},
		{
		...
		{
			name:      "nil values",
			values:    map[string]any{"fbs": nil, "hba1c": nil},
			wantValid: true,
			wantWarn:  0,
		},
		{
			name:      "non-numeric values ignored",
			values:    map[string]any{"fbs": "not a number", "hba1c": 5.4},
			wantValid: true,
			wantWarn:  0,
		},
	}
