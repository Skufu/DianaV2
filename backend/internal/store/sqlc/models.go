...
// Authentication event logs for real-time admin monitoring
type AuthEvent struct {
	ID pgtype.UUID `json:"id"`
	// Type of auth event: login, logout, failed_login, token_refresh
	EventType string `json:"event_type"`
	// User email (optional for failed logins)
	...
	// Parsed device information (browser, os, device)
	DeviceInfo []byte `json:"device_info"`
	// Geolocation data (country, city, lat, long)
	Location []byte `json:"location"`
	// Additional event-specific data (failure_reason, session_id, etc.)
