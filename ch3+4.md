...
**Implementation Reference:** Ian_ML/training/train_binary_v2_no_bp.py:302-406 (threshold optimization), models/binary_v2_no_bp/results/logo_fold_metrics.csv (per-fold threshold mode)
