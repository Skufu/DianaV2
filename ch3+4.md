...
<!-- CITATION NEEDED: "Clinical biomarkers (triglycerides, LDL, fasting glucose) often exhibit right-skewed distributions" - cite clinical laboratory literature on biomarker distributions -->
...
```python
# From train_binary_v2_no_bp.py:201-215
...
<!-- CITATION NEEDED: ADA glycemic thresholds (HbA1c >= 6.5% for diabetes, 5.7-6.4% for prediabetes) - cite ADA Standards of Care 2024 or appropriate year -->
...
<!-- CITATION NEEDED: Reference Lundberg & Lee (2017) or appropriate SHAP paper -->
...
<!-- CITATION NEEDED: Reference ISO/IEC 25010:2011 official standard or IEEE article -->
DIANA's software quality evaluation follows the **ISO/IEC 25010 System and Software Quality Requirements and Evaluation (SQuaRE)** standard, providing a structured framework for assessing product quality across eight characteristics. This methodology ensures that quality attributes are **explicitly measured** rather than asserted, aligning with software engineering best practices for clinical applications.
...
<!-- CITATION NEEDED: Reference Cronbach (1951) or modern psychometrics textbook for Cronbach's alpha -->
Internal consistency reliability is assessed using **Cronbach's alpha**, a measure of how closely related a set of items are as a group. The methodology follows:
...
<!-- CITATION NEEDED: "Studies using random k-fold splits or single train-test splits on NHANES data report AUC values 0.05-0.15 higher than LOGO-based estimates" - need citation for this specific claim about NHANES CV methods -->
<!-- CITATION NEEDED: "AUC >= 0.70 constitutes clinically acceptable screening performance" - need citation for this clinical threshold standard -->
...
<!-- CITATION NEEDED: Verify Brooke (1996) is the correct reference for SUS benchmarks - full citation needed -->
<!-- CITATION NEEDED: "SUS Score > 70 (Acceptable threshold)" - cite source for this specific threshold -->
...
<!-- CITATION NEEDED: Reference Braun & Clarke (2006) for thematic analysis methodology - verify this is the correct full citation -->
...
<!-- CITATION NEEDED: Reference original Gestalt psychology sources (Wertheimer, Köhler, Koffka) or modern UX textbook -->
...
*Note: UI visuals are placeholders pending capture.*
