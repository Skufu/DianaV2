...
- [ ] Fix auth.spec.js:131 - should show error for invalid credentials
- [ ] Fix auth.spec.js:171 - should prevent double submit while login is loading
...
- [ ] Fix navigation.spec.js:131 - should show primary navigation items
- [ ] Fix navigation.spec.js:147 - should hide sidebar on profile tab
- [ ] Fix navigation.spec.js:154 - should navigate to education and export screens
- [ ] Fix navigation.spec.js:163 - should open health trends and show empty state
- [ ] Fix navigation.spec.js:170 - should show profile error state when profile API fails
