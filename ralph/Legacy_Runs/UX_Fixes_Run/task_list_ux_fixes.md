...
- [x] Fix api.js:645-647 - Change `/admin/stats` to `/admin/dashboard` to match backend endpoint
...
- [x] Delete dashboard/Dashboard_user.jsx - Remove legacy file with syntax errors (unused, hazardous)
- [x] Fix api.js:649-652 - Remove or disable adminExportResearchDataApi (endpoint not registered)
...
- [x] Consolidate PDFExport.jsx - Make it use exportPDFApi from api.js instead of direct fetch
...
- [x] Test profile page - sidebar visible, form syncs on data load
- [x] Run lint: `npm run lint` in frontend dir
