...
**Literature-Derived Feature Weights:** The clustering weights function as feature scaling multipliers before Euclidean distance computation—a domain-knowledge injection technique. Weights were derived through literature synthesis of metabolic biomarker importance in T2DM clustering and insulin resistance research. Higher weights amplify a feature's influence on cluster separation. For a standardized patient vector z and centroid c_k, the weighted distance used for assignment is:
...
The following metrics define the planned UAT and expert-review measurement framework. Empirical values are not reported because formal UAT and expert review have not yet been completed.
...
| Clinical Face-Validity Rating (Expert - Risk Output Plausibility) | >= 4.0/5.0 | [TBD after expert review] |
| Clinical Face-Validity Rating (Expert - SHAP Clarity) | >= 4.0/5.0 | [TBD after expert review] |
...
**Expert Feedback Collection Plan**

The expert clinical evaluator review is planned but not yet completed. Therefore, this thesis draft does not report expert ratings or quotes. The planned expert review criteria are:
...
| Expert Review | Clinical evaluator assessments (n=2 target) | [TBD] | Not started |
| Data Analysis | SUS scoring, task metrics, thematic analysis | [TBD after data collection] | Not started |
| Report Generation | UAT summary, expert feedback synthesis | [TBD after data analysis] | Not started |
