...
|---|---|---|---|
| Public ingress | Public traffic enters through reverse proxy | Live DNS resolved to `143.198.222.21`; ports 80 and 443 accepted connections; HTTP redirected to HTTPS; direct application ports 8080, 5000, 5001, and 5432 timed out externally | Live external exposure check passed |
