...
> **For detailed RAG-friendly references, see [`07-research/`](07-research/README.md)**
...
> **See**: [rationale.md § Population Inclusion](../03-ml/rationale.md#0-population-inclusion-postmenopausal-women-only) for full defense of this decision, including STRAW+10 staging limitations and panel Q&A preparation.
...
> **Note on TC**: Total Cholesterol was collected but excluded from the predictive model to avoid multicollinearity (TC ≈ LDL + HDL + TG/5). LDL and HDL are retained as separate features per clinical practice. See [rationale.md](../03-ml/rationale.md#1b-feature-exclusion-total-cholesterol-tc).
...
> **See also**: [biomarkers.md](biomarkers.md)
...
> **Note**: Clinical model excludes HbA1c/FBS to avoid circular reasoning. See [rationale.md](../03-ml/rationale.md).
...
> **See also**: [ml_algorithms.md](ml_algorithms.md)
...
> **See also**: [feature_selection.md](feature_selection.md)
...
> **See also**: [diabetes_subgroups.md](diabetes_subgroups.md)
...
> **See also**: [ui_requirements.md](ui_requirements.md)
