...
| `Ian_ML/training/train_binary_v2.py` | Different list - 13 features |
| `Ian_ML/training/train_binary_v2_no_bp.py` | Different list - 13 features |
...
# Classification features (13 features)
CLINICAL_FEATURES = [
