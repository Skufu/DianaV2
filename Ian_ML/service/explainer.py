...
Usage:
    from Ian_ML.service.explainer import SHAPExplainer
...
def get_clinical_explainer() -> Optional[SHAPExplainer]:
    ...
    if _clinical_explainer is None:
        try:
            from Ian_ML.service.predict import CLINICAL_FEATURES, CLINICAL_MODELS_DIR
...
def get_ada_explainer() -> Optional[SHAPExplainer]:
    ...
    if _ada_explainer is None:
        try:
            from Ian_ML.service.predict import REQUIRED_FEATURES
