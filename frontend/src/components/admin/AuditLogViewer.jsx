...
const AuditLogViewer = ({ token }) => {
  ...
  const formatAction = action => {
    ...
    return <span className={colors[action] || 'text-slate-300'}>{action}</span>;
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card p-4">
        <form onSubmit={handleSearch} className="flex flex-wrap gap-4 items-end">
          <div className="flex-1 min-w-[150px]">
            <label htmlFor="audit-actor-search" className="text-slate-400 text-sm block mb-1">
              Actor
            </label>
          ...
          <div>
            <label htmlFor="audit-action-filter" className="text-slate-400 text-sm block mb-1">
              Action
            </label>
            <select
          ...
          <div>
            <label htmlFor="audit-start-date" className="text-slate-400 text-sm block mb-1">
              From Date
            </label>
            <div className="relative">
              <Calendar
          ...
          <div>
            <label htmlFor="audit-end-date" className="text-slate-400 text-sm block mb-1">
              To Date
            </label>
            <input
              id="audit-end-date"
      ...
      {/* Error State */}
      {error && (
        <div className="glass-card p-4 border border-rose-500/30 text-rose-400">{error}</div>
      )}
