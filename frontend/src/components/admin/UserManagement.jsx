      ...
      <div className="glass-card p-4">
        <form onSubmit={handleSearch} className="flex flex-wrap gap-4 items-end">
          <div className="flex-1 min-w-[200px]">
            <label htmlFor="user-search" className="text-slate-400 text-sm block mb-1">
              Search
            </label>
          ...
          <div>
            <label htmlFor="user-role-filter" className="text-slate-400 text-sm block mb-1">
              Role
            </label>
            <select
              id="user-role-filter"
          ...
          <div>
            <label htmlFor="user-status-filter" className="text-slate-400 text-sm block mb-1">
              Status
            </label>
            <select
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="glass-card p-6 w-full max-w-md m-4">
            ...
            <form onSubmit={handleCreateUser} className="space-y-4">
              <div>
                <label htmlFor="create-user-email" className="text-slate-300 text-sm block mb-1">
                  Email
                </label>
                <input
              ...
              <div>
                <label htmlFor="create-user-password" className="text-slate-300 text-sm block mb-1">
                  Password
                </label>
                <input
              ...
              <div>
                <label htmlFor="create-user-role" className="text-slate-300 text-sm block mb-1">
                  Role
                </label>
                <select
                  id="create-user-role"
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="glass-card p-6 w-full max-w-md m-4">
            ...
            <form onSubmit={handleUpdateUser} className="space-y-4">
              <div>
                <label htmlFor="edit-user-email" className="text-slate-300 text-sm block mb-1">
                  Email
                </label>
                <input
                  id="edit-user-email"
              ...
              <div>
                <label htmlFor="edit-user-role" className="text-slate-300 text-sm block mb-1">
                  Role
                </label>
                <select
                  id="edit-user-role"
