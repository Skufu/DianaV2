// AdminDashboard: System-wide statistics for admin users
...
import { Shield, Users, Activity, Building2, TrendingUp, AlertTriangle } from 'lucide-react';
        ...
        <div className="space-y-6 animate-fade-in pb-8">
            <header>
                ...
                <p className="text-slate-400 text-sm mt-1">
                    System-wide statistics and clinic management
                </p>
            </header>
