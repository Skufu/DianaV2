...
const Sidebar = ({
  ...
  const adminNavItems = [{ id: 'admin', icon: Shield, label: 'Overview' }];
  ...
  return (
    ...
    >
      ...
      {/* Logo Area */}
      <div
        className={`p-6 lg:p-8 flex items-center ${isCollapsed ? 'justify-center' : 'justify-center lg:justify-start'} gap-3`}
      >
              ...
              <div className="relative z-20 flex items-center gap-4">
                <Icon
                  ...
                  className={
                    isActive
                      ? 'text-diana-forest'
                      : 'text-diana-text-muted group-hover:text-diana-forest transition-colors'
                  }
