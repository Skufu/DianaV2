  ...
  return (
    ...
    >
      <motion.div
        ...
        whileHover="hover"
        className="glass-card p-8 bg-white hover:bg-white/80 transition-colors"
      >
        <div className="flex items-center justify-between mb-4">
          <div className="w-14 h-14 rounded-2xl bg-diana-lime/10 flex items-center justify-center">
            <motion.div
              whileHover={{ scale: isReduced ? 1 : 1.05, rotate: isReduced ? 0 : 5 }}
        ...
        <motion.h3
          ...
          variants={fadeIn}
          className="text-4xl font-serif font-bold text-diana-text-primary"
        >
          {totalAssessments}
        </motion.h3>
        <p className="text-diana-text-secondary font-bold text-sm mt-2 uppercase tracking-wide">
          Total Assessments
        </p>
      </motion.div>
      ...
      >
        ...
        <motion.h3
          whileHover={{ scale: isReduced ? 1 : 1.02 }}
          variants={fadeIn}
          className={`text-4xl font-serif font-bold ${riskTextClass}`}
        >
          {avgRiskScore}%
        </motion.h3>
        <p className="text-diana-text-secondary font-bold text-sm mt-2 uppercase tracking-wide">
      ...
      >
        ...
        <p
          className="text-diana-text-secondary font-bold text-sm mt-2 uppercase tracking-wide"
          title="Unique patterns of Type 2 Diabetes manifestation identified by the model"
        >
          T2DM Subtypes
        </p>
      </motion.div>
