...
const GROUP_COLORS = ['#7C3AED', '#06B6D4', '#10B981', '#F59E0B', '#F43F5E', '#6366F1', '#8B5CF6'];
...
const CohortAnalysis = ({ token }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-8">
      ...
      {error && !loading && (
        <div className="glass-card p-6 border border-rose-500/30 text-rose-400">{error}</div>
      )}
                  ...
                  >
                    <td className="py-3 px-4 font-medium flex items-center gap-2">
                      <div
                        ...
                        style={{
                          backgroundColor: GROUP_COLORS[groups.indexOf(g) % GROUP_COLORS.length],
                        }}
                      />
                      {g.name}
                    </td>
                    ...
                    <td className="text-right py-3 px-4">
                      {g.avg_risk_score?.toFixed(1) || 'N/A'}%
                    </td>
                  </tr>
                ))}
              </tbody>
