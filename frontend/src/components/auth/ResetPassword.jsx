    ...
    switch (field) {
      ...
      case 'password':
        ...
        if (touched.confirmPassword && confirmPassword) {
          setFieldErrors(prev => ({ ...prev, confirmPassword: value !== confirmPassword ? 'Passwords do not match' : '' }));
        }
        break;
        ...
        >
          <motion.form onSubmit={handleSubmit} className="space-y-5" initial={false} noValidate>
            ...
            <div className="space-y-1.5">
              <label htmlFor="reset-token" className="text-xs font-semibold uppercase tracking-wide text-slate-500 ml-1">Reset Token</label>
            ...
            {/* New Password Field */}
            <div className="space-y-1.5">
              <label htmlFor="reset-password" className="text-xs font-semibold uppercase tracking-wide text-slate-500 ml-1">New Password</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-diana-forest-light transition-colors">
                  <Lock size={18} />
                </div>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                <label htmlFor="reset-confirm-password" className="text-xs font-semibold uppercase tracking-wide text-slate-500 ml-1">Confirm New Password</label>
              ...
              <FieldError id="reset-confirm-error" message={touched.confirmPassword ? fieldErrors.confirmPassword : ''} />
            </div>
