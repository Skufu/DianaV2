...
export const patientSchema = z.object({
  ...
  age: z
    ...
    .max(120, 'Invalid age')
    .nullable(),
  height: z.string().max(5, 'Invalid height').nullable(),
  weight: z.string().max(5, 'Invalid weight').nullable(),
...
export const assessmentSchema = z.object({
  ...
  bmi: z.number().min(10, 'BMI too low').max(70, 'BMI too high').optional(),
});
