#!/bin/bash
# =============================================================================
# DIANA ML Pipeline - Clinical Retrain Script
...
#        Then run: ./scripts/dev/retrain-clinical.sh
# =============================================================================
...
echo ""
echo "============================================================"
echo -e "${BLUE}DIANA ML Pipeline - Clinical Retrain${NC}"
echo "============================================================"
echo ""
...
if [ ! -d "data/nhanes/raw" ]; then
    ...
    echo "  ./scripts/dev/retrain-clinical.sh"
    exit 1
fi
