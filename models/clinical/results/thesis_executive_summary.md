# DIANA Thesis Executive Summary
...
|---------|-------|--------------|
| AUC-ROC | 0.6732 (95% CI: [0.5647, 0.7817]) | Moderate discriminative ability, exceeds random guessing (0.50) |
...
|-------|-----|-----------|-------------|---------------|-----|----------------|
| **XGBoost** | 0.6732 | [0.5647, 0.7817] | 0.4011 | 40.6% | 89.6% | **RECOMMENDED**: Best AUC, good calibration |
